...
<head>
      ...
      <script type="text/javascript">
            ...
            function fetch_data()
            {
               ...
               console.log(nid);  
               console.log(cid);
               $.post('_applicants_search.php',
               {national_id:nid, company_id:cid}, 
               function(data, status)
               {  
                    console.log(data);
                    ...
                    {
                      $('.myrow').remove();
                      sweetAlert("Oops...", "No Records Found For This Company With Above Criteria", "error");
                    } 
               });
...
<body style="background-color:#00838f">
 ...
 <div class="container_middle">	
       <div class="row">  
        <form class="form-inline" role="form" id="login_form" onsubmit="fetch_data()">
                    ...
                    <thead>
                        <tr>
                            ...
                            <?php
                             ...
                             {
                              echo ' <th style="text-align: center;" colspan="2">Operation</th>';
                             }
                            ?>
                        </tr>                        
                    </thead>
                      ...
                      <?php
                         ...
                         $sql="SELECT `members`.`meber_id`, `members`.`names`, `members`.`gender`, `members`.`phone`, 
                               `members`.`national_id`, `members`.`designation`, `members`.`location`, `members`.`employee_no`,
                                ...
                                WHERE `members`.`application_status`='Pending'";
                         $results=mysql_query($sql);
                         $num=1;
                         while ($row=mysql_fetch_row($results)) 
                         {
